...
// Gap (Non-AI): No shopping integration
// No shopping integration
import React, { useState } from 'react';

export default function GapNoShoppingIntegrationPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-shopping-integration/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No shopping integration</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No shopping integration</p>
