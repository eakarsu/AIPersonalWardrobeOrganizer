...
// Gap (Non-AI): Limited notifications layer (1 mention)
// Limited notifications layer (1 mention)
import React, { useState } from 'react';

export default function GapLimitedNotificationsLayer1MentionPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-notifications-layer-1-mention/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Limited notifications layer (1 mention)</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Limited notifications layer (1 mention)</p>
