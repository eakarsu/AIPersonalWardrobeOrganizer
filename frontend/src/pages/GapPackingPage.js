...
export default function GapPackingPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-packing/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Packing</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Packing-lists without /weather-pack (weather-aware packing recommendations)</p>
