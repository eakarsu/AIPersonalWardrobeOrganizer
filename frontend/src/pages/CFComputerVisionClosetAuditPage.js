...
// Custom Feature: Computer vision closet audit
// Computer vision closet audit: Batch process photos of closet; AI auto-tags all items, detects duplicates, quality-assesses condition; suggests decluttering
import React, { useState } from 'react';

export default function CFComputerVisionClosetAuditPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-computer-vision-closet-audit/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Computer vision closet audit</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Computer vision closet audit: Batch process photos of closet; AI auto-tags all items, detects duplicates, quality-assesses condition; suggests decluttering</p>
