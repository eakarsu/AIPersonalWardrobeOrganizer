...
export default function GapWearPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-wear/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Wear</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Wear-logs without /wear-pattern-analysis (identify favorite pieces, unused items)</p>
